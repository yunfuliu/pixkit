	...
	namespace enhancement{
		...
		namespace local{
			...
			*/
			...
			/**
			* @brief		local contrast enhancement
			* @brief		paper: S. M. Pizer, E. P. Amburn, J. D. Austin, et al.: Adaptive Histogram Equalization and Its Variations. Computer Vision, Graphics, and Image Processing 39 (1987) 355­-368
